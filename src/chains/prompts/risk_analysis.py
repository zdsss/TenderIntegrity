...
第2步：判断相同内容是否为行业通用表述（如法规引用、质保承诺、交货条款等）
第3步：评估内容敏感程度——技术方案/技术参数 > 商务条款/价格 > 通用声明
...
- risk_type: string，枚举值之一: "verbatim_copy" | "semantic_paraphrase" | "template_reuse" | "key_param_duplicate" | "normal_overlap"
